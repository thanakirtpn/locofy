      ...
      <div className="self-stretch flex flex-row flex-wrap items-start justify-center py-0 px-2.5 box-border max-w-full text-left text-5xl text-gray-white">
        <div className="w-[1300px] flex flex-col items-center justify-start gap-[24px_0px] max-w-[1300px] min-h-[536px] mq1400:max-w-full">
          <div className="self-stretch grid flex-row items-start justify-center gap-[0px_26px] max-w-full grid-cols-[repeat(3,_minmax(312px,_1fr))] lg:justify-center lg:grid-cols-[repeat(2,_minmax(312px,_541px))] mq825:grid-cols-[minmax(312px,_1fr)]">
            <div className="h-[241px] rounded-lg flex flex-row items-start justify-start relative bg-[url('/public/card-1@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full">
            ...
            <div className="h-[241px] rounded-lg flex flex-row items-start justify-start relative bg-[url('/public/card-2@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full">
              <div className="!m-[0] absolute top-[16px] left-[16px] flex flex-col items-start justify-start gap-[11px_0px]">
                <h3 className="m-0 relative text-inherit leading-[32px] font-semibold font-inherit mq450:text-lgi mq450:leading-[26px]">
                  Centerville
                </h3>
            ...
            <div className="h-[241px] rounded-lg flex flex-row items-start justify-start relative bg-[url('/public/card-3@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full">
              <div className="!m-[0] absolute top-[16px] left-[16px] flex flex-col items-start justify-start gap-[11px_0px]">
                <h3 className="m-0 relative text-inherit leading-[32px] font-semibold font-inherit mq450:text-lgi mq450:leading-[26px]">
                  Centerville
                </h3>
          ...
          <div className="self-stretch flex flex-row items-start justify-center gap-[0px_24px] max-w-full lg:flex-wrap">
            <div className="h-[241px] flex-1 rounded-lg flex flex-row items-start justify-start p-2.5 box-border relative bg-[url('/public/card-4@3x.png')] bg-cover bg-no-repeat bg-[top] min-w-[415px] max-w-full mq825:min-w-full">
              <div className="!m-[0] absolute top-[16px] left-[16px] flex flex-col items-start justify-start gap-[11px_0px]">
                <h3 className="m-0 relative text-inherit leading-[32px] font-semibold font-inherit mq450:text-lgi mq450:leading-[26px]">
                  Arlington
                </h3>
            ...
            <div className="h-[241px] flex-1 rounded-lg flex flex-row items-start justify-start p-2.5 box-border relative bg-[url('/public/card-5@3x.png')] bg-cover bg-no-repeat bg-[top] min-w-[415px] max-w-full mq825:min-w-full">
              <div className="!m-[0] absolute top-[16px] left-[16px] flex flex-col items-start justify-start gap-[11px_0px]">
                <h3 className="m-0 relative text-inherit leading-[32px] font-semibold font-inherit mq450:text-lgi mq450:leading-[26px]">
                  Centerville
                </h3>

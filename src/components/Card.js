...
const Card = ({ propBackgroundImage }) => {
  ...
  return (
    <div
      className="h-[426px] w-[370px] rounded-md flex flex-col items-center justify-end p-6 box-border bg-[url('/public/card-11@3x.png')] bg-cover bg-no-repeat bg-[top] min-w-[355px] max-w-[370px] text-left text-base text-gray-white font-body-large-400 mq450:w-[calc(100%_-_40px)]"
      style={card1Style}
    >
